...
export function createBuiltinSkills(): LoadedSkill[] {
  return [
    builtin({
      ...
      steps: ["List the workspace", "Read manifests and relevant files", "Search only when needed", "Summarize stack, risks and next actions"],
      allowedTools: ["list_tree", "read_file", "read_range", "search_text", "file_metadata", "hash_file"],
    ...
    builtin({
      ...
      steps: ["Plan minimal structure", "Write files through workspace tools", "Read back critical files", "Package only when requested", "Summarize validation"],
      allowedTools: ["list_tree", "read_file", "read_range", "write_file", "create_directory", "replace_text", "search_text", "create_zip"],
    ...
    builtin({
      ...
      steps: ["Inspect or create manifest", "Implement requested screens/components", "Verify imports/config", "Package only when requested", "Report whether a real build was executed"],
      allowedTools: ["list_tree", "read_file", "read_range", "write_file", "create_directory", "copy_file", "move_file", "replace_text", "search_text", "diff_files", "create_zip"],
    ...
    builtin({
      ...
      steps: ["Inspect exact error and related file", "Apply smallest fix", "Diff or re-read affected code", "Run available validation or state that it was unavailable"],
      allowedTools: ["list_tree", "read_file", "read_range", "write_file", "replace_text", "search_text", "diff_files"],
    ...
    builtin({
      ...
      steps: ["Define the research question", "Retrieve relevant public sources", "Separate evidence from inference", "Summarize with source context"],
      allowedTools: ["http_get", "read_file", "write_file"],
